...
class ViewDataUser extends StatefulWidget {
  @override
  _ViewDataUserState createState() => _ViewDataUserState();
}

class _ViewDataUserState extends State<ViewDataUser> {
  List dataUser = [];

  Repository repository = Repository();
  getData() async {
    dataUser = await repository.getAllUser();
    setState(() {});
  }
