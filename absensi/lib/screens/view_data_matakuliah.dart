...
class ViewDataMatakuliah extends StatefulWidget {
  @override
  _ViewDataMatakuliahState createState() => _ViewDataMatakuliahState();
}

class _ViewDataMatakuliahState extends State<ViewDataMatakuliah> {
  List dataMatakuliah = [];
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  children: [
                    for (var item in dataMatakuliah)
                      UserCard(
                        status: 'kode  : ' + item['kode_matakuliah'],
                        tgl: '',
                        jam: 'nama  : ' + item['nama_matakuliah'],
